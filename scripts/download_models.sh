...
FILES=(
  "diffusion_models|$MODEL_DIFFUSION_REPO|$MODEL_DIFFUSION_PATH|$MODEL_DIFFUSION|$MODEL_DIFFUSION_BYTES"
  "text_encoders|$MODEL_TEXT_ENCODER_REPO|$MODEL_TEXT_ENCODER_PATH|$MODEL_TEXT_ENCODER|$MODEL_TEXT_ENCODER_BYTES"
