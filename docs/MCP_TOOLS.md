...
24 tools exposed by `src/minimax_mcp/server.py`.
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `last_n` | integer | no | Quantos últimos resultados processados mostrar |
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `watch_seconds` | number | no | Segundos ouvindo o progresso do sampler. 0 pula e retorna só a fila |
